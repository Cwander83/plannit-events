export const styles = {
	...
	inputStyle:
		'mt-1 focus:border-primary focus:ring-0 focus:border-3 focus:text-xl block w-full  text-center text-xl tracking-wider border-gray-dark border-t-0 border-l-0 border-r-0 placeholder-gray-light',
	checkboxStyle:
